...
/**
 * Implementation of {@link SignUpValidationService}
 */
@Service
public class SignUpValidationServiceHandler implements SignUpValidationService, Validator {
     ...
     */
    @Autowired
    public SignUpValidationServiceHandler(final UserService userService) {
